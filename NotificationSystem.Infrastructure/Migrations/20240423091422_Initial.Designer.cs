...
namespace NotificationSystem.Infrastructure.Migrations
{
    ...
    [Migration("20240423091422_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotificationSystem.Domain.Subscription.Subscription", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseHiLo(b.Property<int>("SubcriptionId"), "subscription_subscriptionid_seq");
            ...
            modelBuilder.Entity("NotificationSystem.Domain.Subscription.Subscriber", b =>
                {
                    b.OwnsOne("NotificationSystem.Domain.Subscription.SubscriptionWallet", "Wallet", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("LastTransactionDate")
                                .HasColumnType("timestamp with time zone");

                            b1.Property<int>("LastTransactionId")
                                .HasColumnType("integer");
